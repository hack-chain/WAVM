...
enum class NodeType : U8 {
    lit, zeroOrMore, oneOrMore, optional, alt, seq,
};
...
void RegExp::addToNFA(const char *regexpString, NFA::Builder *nfaBuilder, NFA::StateIndex initialState, NFA::StateIndex finalState) {
