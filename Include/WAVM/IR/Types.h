...
namespace WAVM {
    namespace IR {
        ...
        template<typename>
        constexpr ValueType inferValueType();

        template<>
        constexpr ValueType inferValueType<I32>() { return ValueType::i32; }

        template<>
        constexpr ValueType inferValueType<U32>() { return ValueType::i32; }

        template<>
        constexpr ValueType inferValueType<I64>() { return ValueType::i64; }

        template<>
        constexpr ValueType inferValueType<U64>() { return ValueType::i64; }

        template<>
        constexpr ValueType inferValueType<F32>() { return ValueType::f32; }

        template<>
        constexpr ValueType inferValueType<F64>() { return ValueType::f64; }

        template<>
        constexpr ValueType inferValueType<Runtime::Object *>() { return ValueType::anyref; }

        template<>
        constexpr ValueType inferValueType<Runtime::Function *>() {
            return ValueType::anyfunc;
        }

        template<>
        constexpr ValueType inferValueType<const Runtime::Object *>() {
            return ValueType::anyref;
        }

        template<>
        constexpr ValueType inferValueType<const Runtime::Function *>() {
            return ValueType::anyfunc;
        }

        template<typename T>
        inline TypeTuple inferResultType() {
            return TypeTuple(inferValueType<T>());
        }

        template<>
        inline TypeTuple inferResultType<void>() { return TypeTuple(); }
...
template<>
struct WAVM::Hash<WAVM::IR::TypeTuple> {
...
template<>
struct WAVM::Hash<WAVM::IR::FunctionType> {
