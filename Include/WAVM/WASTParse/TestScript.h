    ...
    namespace WAST {
        ...
        struct ModuleAction : Action {
            ...
            ModuleAction(TextFileLocus &&inLocus,
                         ...
                         IR::Module *inModule)
                    : Action(ActionType::_module, std::move(inLocus)), internalModuleName(inInternalModuleName),
                      module(inModule) {
            }
        };
        ...
        struct InvokeAction : Action {
            ...
            InvokeAction(TextFileLocus &&inLocus,
                    ...
                    : Action(ActionType::invoke, std::move(inLocus)), internalModuleName(inInternalModuleName),
                      exportName(inExportName), arguments(inArguments) {
            }
        };
        ...
        struct GetAction : Action {
            ...
            GetAction(TextFileLocus &&inLocus,
                      std::string &&inInternalModuleName,
                      std::string &&inExportName)
                    : Action(ActionType::get, std::move(inLocus)), internalModuleName(inInternalModuleName),
        ...
        struct RegisterCommand : Command {
            ...
            RegisterCommand(TextFileLocus &&inLocus,
                            ...
                            std::string &&inInternalModuleName)
                    : Command(Command::_register, std::move(inLocus)), moduleName(inModuleName),
        ...
        struct AssertReturnCommand : Command {
            ...
            AssertReturnCommand(TextFileLocus &&inLocus,
                    ...
                    : Command(Command::assert_return, std::move(inLocus)), action(inAction),
        ...
        struct AssertTrapCommand : Command {
            ...
            AssertTrapCommand(TextFileLocus &&inLocus,
                    ...
                    : Command(Command::assert_trap, std::move(inLocus)), action(inAction),
        ...
        struct AssertThrowsCommand : Command {
            ...
            AssertThrowsCommand(TextFileLocus &&inLocus,
                    ...
                    : Command(Command::assert_throws, std::move(inLocus)), action(inAction),
                      exceptionTypeInternalModuleName(inExceptionTypeInternalModuleName),
                      exceptionTypeExportName(inExceptionTypeExportName), expectedArguments(inExpectedArguments) {
            }
        };
        ...
        struct AssertInvalidOrMalformedCommand : Command {
            ...
            AssertInvalidOrMalformedCommand(Command::Type inType,
                    ...
                    : Command(inType, std::move(inLocus)), wasInvalidOrMalformed(inWasInvalidOrMalformed),
                      quotedModuleType(inQuotedModuleType), quotedModuleString(inQuotedModuleString) {
            }
        };
